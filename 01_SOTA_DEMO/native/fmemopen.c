...
#ifdef _WIN32
/* Windows lacks both fmemopen and funopen. Back the FILE* with a tmpfile
 * holding a copy of the buffer. Slow (disk write) but the SOTA wad files
 * we feed mikmod are at most a few hundred KB. */

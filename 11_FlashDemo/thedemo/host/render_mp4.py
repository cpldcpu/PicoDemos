...
AUDIO_FILE = HERE.parent / "assets" / "VOLTAGE CONNECTING.mp3"
ARTIFACTS_DIR = Path(r"C:\Users\tboes\.gemini\antigravity\brain\4be338a2-9396-4223-aea3-d77672d0a91a\artifacts")
OUTPUT_MP4_LOCAL = HERE / "voltage_demo_60fps.mp4"
OUTPUT_MP4_ARTIFACT = ARTIFACTS_DIR / "voltage_demo_60fps.mp4"

TOTAL_FRAMES = 9493 # 158200 ms / (1000 / 60) ms per frame = 9492.00 frames
...
def main():
    print("=== VOLTAGE MP4 Offline Renderer (60 FPS) ===")

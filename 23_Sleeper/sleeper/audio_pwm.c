 ...
 * From HELION's audio_pwm.c, unchanged apart from the guard names.
 */
#include "device.h"
...
#ifndef SLEEPER_SILENT_PUMP
#define SLEEPER_SILENT_PUMP 0
#endif
#define RING 1024u
...
/* SLEEPER_SILENT_PUMP (off by default, never in a release build) replaces the

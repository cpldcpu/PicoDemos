...
void vga_160_present(void)
{
    ...
    /* Copy fb160 into the streaming texture. The PC's display path will
     * scale this to the window — RenderSetLogicalSize(320,240) earlier
     * makes the upscale handle 160→320 the same way the Pico would. */
    void *pixels = NULL;
    int   pitch  = 0;

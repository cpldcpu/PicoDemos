...
#define BEAT_SAMPLES 12000
#define DURATION_SAMPLES (BEAT_SAMPLES * 320u)
#define DURATION_SECONDS 160.f
#ifdef PICO_BUILD
#include "pico.h"
...
unsigned demo_texels(void);
typedef struct {uint32_t prepare,wait,field,mesh,other;} DemoProfile;
DemoProfile demo_profile(void);

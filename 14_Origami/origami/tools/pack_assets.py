...
ASSETS = [
    ...
    # Scene 0 title backdrop — MODE_320 8bpp. The square deep-field master is
    # stretched to 320x240 (fine for a star field). reserved=32 leaves slots
    # 224..255 free for the title text + copper accents.
    ("title_bg",    "title_star_pano_640.png", "8bpp",   320, 240, True,   None,       32),
    # Scene 5 lensing background — equirectangular panorama, RGB565 truecolor,
    # 256x128 (power-of-two width for the free yaw wrap). Indexed by the
    # gravitational-lensing remap LUT.
    ("star_pano",   "star_pano_256x128.png",   "rgb565", 256, 128, False,  None),
    # Scene 4 accretion disk — top-down (Cartesian) plasma disk, RGB565,
    # sampled as a tilted plane by the Mode-7 transform.
    ("disk_tex",    "accretion_disk_256.png",  "rgb565", 256, 256, False,  None),
    # Scene 2 star ignition — 3 seamless granulation tiles, RGB565, summed
    # at different scales/offsets through a blackbody ramp.
    ("solar0",      "solar_tile_0.png",        "rgb565", 128, 128, False,  None),
    ("solar1",      "solar_tile_1.png",        "rgb565", 128, 128, False,  None),
    ("solar2",      "solar_tile_2.png",        "rgb565", 128, 128, False,  None),
    # Scene 7 rebirth — newborn-universe backdrop, MODE_320 8bpp.

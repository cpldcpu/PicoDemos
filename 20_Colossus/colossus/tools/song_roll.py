#!/usr/bin/env python3
"""Piano roll of the COLOSSUS score, straight from song.c's accessors.
...
SECTIONS = [(0, "overture"), (8, "the plain"), (24, "the hand"), (40, "the heart"),
            (56, "the eye"), (72, "the forge"), (88, "the spine"), (112, "the crown, key up"),
            (128, "the colossus"), (144, "coda")]
...
def main():
    ...
    ax.axvline(112, color="#c00", lw=2, alpha=0.6)
    ...
    ax.set_ylabel("pitch")
    ax.set_title("COLOSSUS -- piano roll from song.c (D minor at 125 BPM, up a tone for the crown, bars 112-127)")
